...
import { AccountBalanceWallet, AccountBox, AdsClick, EventAvailable, ExpandLess, ExpandMore, ForwardToInbox, LockOpen, Logout, ManageHistory, RequestQuote, UploadFile, WorkHistory, WorkOff } from '@mui/icons-material';
...
export default function ItAdminNavBar(props) {
    ...
    <>
      ...
      >
        <List sx={{ mt: 8 }} className='navigation-menu'>
          ...
          {/*------------------------leave Management---------------------- */}
          {
              pagesToBeNotAccessed !== null && (!pagesToBeNotAccessed.includes('UploadAttendance') || !pagesToBeNotAccessed.includes('ViewAttendance')) ?
                <>
                 <Divider sx={{ fontSize: 12, fontWeight: 'bold' }}>IT</Divider>
