                                        ...
                                        <Select size='small' label='Month' MenuProps={{ style: { maxHeight: 400 } }} name='month' value={searchSelection.month} onChange={handleSelection} required>
                                            {
                                                Object.keys(months).map(monthNo =>
                                                    <MenuItem key={monthNo} value={monthNo}>{months[monthNo]}</MenuItem>
                                                )
                                            }
                                                                    ...
                                                                    attendanceData.length !== 0 ?
                                                                        <>
                                                                            <Container sx={{ display: "flex", justifyContent: 'center', height: 200 }}  >
                                                                                <Chart
                                                                                    options={options}
                                                                                    series={(attendanceData.length === 0 ? [] : [monthStatistics.presentDays, monthStatistics.approvedLeaves, monthStatistics.unapprovedLeaves.length])}
                                                                                    type="donut"
                                                                                    height={'100%'}
                                                                            ...
                                                                            <Container>
                                                                                <Stack spacing={2}>
                                                                                    <Paper>
                                                                                        <Typography margin={0.8} variant='p' component={'h5'} color={'red'} textAlign={'center'} sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.2)' } }}  >Total Working Days: <span style={{ color: 'black' }}> {monthStatistics.totalWorkingDays}</span></Typography>

                                                                                    </Paper>
                                                                                    <Paper>
                                                                                        <Typography margin={0.8} variant='p' component={'h5'} color={'#2E93fA'} textAlign={'center'} sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.2)' } }}  >Present Days: <span style={{ color: 'black' }}>{monthStatistics.presentDays} </span></Typography>

                                                                                    </Paper>
                                                                                    <Paper>
                                                                                        <Typography margin={0.8} variant='p' component={'h5'} color={'#5BC138'} textAlign={'center'} sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.2)' } }}  >Approved Leaves: <span style={{ color: 'black' }}>{monthStatistics.approvedLeaves}</span></Typography>

                                                                                    </Paper>
                                                                                    <Paper>
                                                                                        <Typography margin={0.8} variant='p' component={'h5'} color={'#FF9800'} textAlign={'center'} sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.2)' } }}  >Unapproved Leaves: <span style={{ color: 'black' }}>{monthStatistics.unapprovedLeaves.length}</span></Typography>
                                                                ...
                                                                <Grid container >
                                                                    ...
                                                                    <Grid item xs={12} sm={12} lg={8}>
                                                                        <Box height={'100%'} width={'100%'} display={'flex'} flexDirection={'column'} justifyContent={'flex-start'} p={1}>
                                                                            ...
                                                                            <DataTable size='small' width={'100%'} resizableColumns scrollable loading={loader} scrollHeight='120px' showGridlines value={monthStatistics.unapprovedLeaves}
                                                                    ...
                                                                    <Grid item xs={12} sm={12} lg={4}>
                                                                        <Container sx={{ height: '100%', width: '100%', }} >
                                                                            <Stack spacing={1.5} display={'flex'} justifyContent={'center'} >
                                                                                <Paper sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.1)' },backgroundImage:'linear-gradient(135deg, #FFFEFF 10%, #D7FFFE 100%);' }}>
                                                                                    <Typography margin={0.8} variant='p' component={'h5'} textAlign={'center'}    >Open Leaves: {balanaceSection.openLeaves}</Typography>

                                                                                </Paper>
                                                                                <Paper sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.1)' },backgroundImage:'linear-gradient(135deg, #FFFEFF 10%, #D7FFFE 100%);'  }}>
                                                                                    <Typography margin={0.8} variant='p' component={'h5'}  textAlign={'center'}  >New Leaves Added: <span style={{ color: 'black' }}>{balanaceSection.newAddedLeaves}</span></Typography>

                                                                                </Paper>
                                                                                <Paper sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.1)' },backgroundImage:'linear-gradient(135deg, #FFFEFF 10%, #D7FFFE 100%);'  }}>
                                                                                    <Typography margin={0.8} variant='p' component={'h5'}  textAlign={'center'}  >Adjusted Leaves: <span style={{ color: 'black' }}>{balanaceSection.adjustedLeaves} </span></Typography>

                                                                                </Paper>
                                                                                <Paper sx={{ transition: 'transform .2s;', "&:hover": { transform: 'scale(1.1)' },backgroundImage:'linear-gradient(135deg, #FFFEFF 10%, #D7FFFE 100%);'  }}>
                                                                                    <Typography margin={0.8} variant='p' component={'h5'}  textAlign={'center'}  >Balance Leaves: <span style={{ color: 'black' }}>{balanaceSection.balanceLeaves}</span></Typography>
